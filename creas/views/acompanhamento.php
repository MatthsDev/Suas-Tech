...
<head>
    ...
    <link rel="stylesheet" href="../../cras/css/style-acompanhamento.css">
...
<body>
    <div class="img">
        <h1 class="titulo-com-imagem">
            <img class="titulo-com-imagem" src="../../cras/img/h1-acompanhamento.svg" alt="Titulocomimagem">
        </h1>
    </div>
...
if (!isset($_GET['buscar_dados'])) {
    ...
    if ($_GET['buscar_dados'] == 'cpf_dec') {
        ...
        $sql = $pdo->prepare("SELECT * FROM creas WHERE cpf = :valorescolhido");
        ...
        if ($sql->rowCount() > 0) {
            ...
            ?>
                    <form method="POST" action="../../cras/controller/processo_acompanhamento.php">
                        <?php
...
<?php
            ...
            echo '<script>alert("Desculpe nos! \nA função LOCALIZAR PELO NIS ainda não está funcionando. \nLogo em breve!"); window.location.href = "acompanhamento.php";</script>';
