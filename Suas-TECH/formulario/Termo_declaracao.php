...
<head>
    ...
    <title>ANEXO I MODELO DE TERMO DE DECLARAÇÃO</title>
...
<body>
    ...
    <form id="declarationForm">
        ...
        <br>
        <p class="paragraph">Eu, <span id="nomeContainer"><span id="nome" class="editable-field" contenteditable="true"></span></span>, NIS: <span id="nis"></span>, CPF: <span id="cpf"></span>, declaro, sob as penas da lei, que todas as pessoas listadas abaixo moram no meu domicílio e possuem o seguinte rendimento total detalhado para cada pessoa, incluindo remuneração de doação, de trabalho ou de outras fontes:</p>
        ...
        <ul>
            <li class="topic">É ilegal deixar de declarar informações ou prestar informações falsas para o Cadastro Único, com o objetivo de participar ou de se manter no Programa Bolsa Família ou em qualquer outro programa social.</li>
            <li class="topic">As famílias que fraudam o Programa Bolsa Família terão o benefício cancelado e responderão processo administrativo instaurado para devolução dos valores recebidos indevidamente, além de responder penal e civilmente pelas fraudes cometidas.</li>
            <li class="topic">A qualquer tempo poderei receber visita domiciliar de servidor do município, para avaliar se a situação socioeconômica da minha família está de acordo com as informações prestadas ao Cadastro Único. Assumo o compromisso de atualizar o cadastro sempre que ocorrer alguma mudança nas informações de minha família, como endereço, renda e trabalho, nascimento ou óbito, entre outras.</li>
        </ul>
        <p class="right">São Bento do Una - PE, <span id="data"></span>.</p>
        <p class="center">______________________________________________________________<br>Assinatura do Responsável pela Unidade Familiar</p>
    </form>
