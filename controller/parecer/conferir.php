...
<head>
    ...
    <link rel="website icon" type="png" href="../../css/icon.png">
    <link rel="stylesheet" type="text/css" href="../../css/style-conferir.css">
    <title>Parecer das visitas</title>
...
$parecer_tec = $dadosv["parecer_tec"];
        ...
        echo "Não foi realizado nenhuma visita a família de código " . $cod_familiar_formatado . "<br>";
