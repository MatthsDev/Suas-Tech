    ...
    <div class="container">
        ...
        <form method="">
            <div>
                ...
                <input type="text" name="buscar" class="inpu1" placeholder="Buscar por qualquer informação do contrato..." required> <span style="cursor: help;" class="material-symbols-outlined" title="Caso sua busca seja feita por CNPJ, lembre-se de colocar os caracteres (. / -) para a busca retornar com sucesso.">
                    info
                </span>
