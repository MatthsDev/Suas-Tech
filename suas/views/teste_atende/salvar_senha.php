...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $pdo->prepare("INSERT INTO senhas (ordem_chegada, senha, cpf_atendido, nome_atendido, tipo_atendimento, tipo_prioridade, data_hora_registro) VALUES (:ordem_chegada, :senha, :cpf_atendido, :nome_atendido, :tipo_atendimento, :prioridade, :data_hora_registro)");
    ...
    $stmt->bindParam(':tipo_atendimento', $tipoAtendimento);
