...
<body>
    ...
    <div class="local">
    <a href='total_peixe' style="color: red;">LOCAL CADASTRO</a>
    <label><b style="color: green;">LOCAL ENTREGA</b></label>
    </div>
    <div class="container">
        <?php
        ...
        header("refresh:$tempo_atualizacao;url=/Suas-Tech/acesso_suporte/total_peixe_entrega");
        ...
        <div class="grafico-container">
            ...
            <?php
            $sql_ano = 'SELECT local_entrega AS lc_cad, COUNT(*) AS quantidade
    FROM peixe
