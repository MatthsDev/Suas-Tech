...
<form id="form" method="POST" action="" onsubmit="return validarFormulario()">
        <div id="form">
            <label>CPF: </label>
            <input type="text" name="cpf" id="cpf" placeholder="Digite o CPF do RESPONSÁVEL:" maxlength="14" required>
...
exit();
        ...
        <table border='1'>
            <tr class="resultado">
                ...
                <td class="resultado" colspan="9"><b><input type="text" name="nome_pessoa" required oninput="this.value = this.value.toUpperCase()"/></b></td>
            ...
            <tr class="resultado">
                ...
                <td class="resultado" colspan="9"><b><input type="text" name="nome_mae_pessoa" required oninput="this.value = this.value.toUpperCase()"/></b></td>
